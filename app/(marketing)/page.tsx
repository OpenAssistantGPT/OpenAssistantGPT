...
export default function IndexPage() {
  ...
  return (
    <>
      <section data-aos="fade-up" className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 py-12 md:py-24 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          {/* <Link
            ...
            className="rounded-2xl bg-muted px-4 py-1.5 text-md font-medium"
            target="_blank"
          >
            Find us on 𝕏
          </Link> */}
      ...
      {/* <section data-aos="fade-up" id="chat" className="container py-12 md:py-24 lg:py-32">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Ask any question about WiseChat to our chatbot powered by OpenAI Assistant API and see how it responds. You can also try the chatbot buttom right of the window.
          </p>
      ...
      <section data-aos="fade-up" id="features" className="container space-y-6 bg-balck-100 py-12 md:py-24 lg:py-32">
      ...
      <section data-aos="fade-up" id="integrations" className="container bg-black-50 py-12 md:py-24 lg:py-32">
      ...
      {/* <section data-aos="fade-up" id="open-source" className="container bg-black-50 py-12 md:py-24 lg:py-32">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          <h2 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl">
            Proudly Open Source
          </h2>
          ...
          <div className="mx-auto mt-10 grid max-w-sm items-start gap-12 sm:max-w-4xl sm:grid-cols-2 lg:max-w-5xl lg:grid-cols-4">
            <div className="flex flex-col space-y-2">
              <div className="space-y-2">
                ...
                <p className="text-md text-gray-500 ">Perfect for personal projects, experiments, or simply getting familiar with our powerful tools.</p>
              </div>
      ...
      <section data-aos="fade-up" id="faq" className="container bg-black-50 space-y-6 py-12 md:py-24 lg:py-32">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          <h2 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl">
            FAQ
          </h2>
