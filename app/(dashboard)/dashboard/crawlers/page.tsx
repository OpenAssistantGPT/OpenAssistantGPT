  ...
  return (
    <DashboardShell>
      ...
      <div className="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4" role="alert">
        ...
        <p className="text-md">Our crawlers don&apos;t support website generated with javascript at runtime yet. If your website isn’t SSR or static we won&apos;t be able to fetch the content.</p>
        <p className="text-md">We recommend use <a className="underline" href="https://github.com/BuilderIO/gpt-crawler">gpt-crawler</a> to crawl your website localy and then upload your file to {siteConfig.name}.</p>
      </div>
      <div>
        {crawlers?.length ? (
