...
import { advancedSettingsSecuritySchema } from "@/lib/validations/advancedSettings";
...
export async function PATCH(
    ...
    try {
        ...
        const payload = advancedSettingsSecuritySchema.parse(body)
        ...
        const chatbot = await db.chatbot.update({
            ...
            data: {
                ...
                allowEveryone: payload.allowEveryone,
                bannedIps: payload.bannedIps,
            },
            select: {
                id: true,
                name: true,
