...
import { ClientInquiries, Crawler } from "@prisma/client"
...
interface InquiryOperationsProps {
    inquiry: Pick<ClientInquiries, "id" | "chatbotId">
}

export function InquiryOperations({ inquiry }: InquiryOperationsProps) {
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem>
                        <Link href={`/dashboard/chatbot/${inquiry.chatbotId}/inquiry/${inquiry.id}`} className="flex w-full">
                            View
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
