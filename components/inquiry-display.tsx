            ...
            {inquiry ? (
                <div className="flex flex-1 flex-col">
                    ...
                    <ScrollArea style={{ height: "70vh" }}>
                        <div className="flex-1 whitespace-pre-wrap space-y-4 p-4 text-md">
                            <div className="flex items-center p-4 text-md text-gray-800 border border-gray-300 rounded-lg bg-gray-50" role="alert">
